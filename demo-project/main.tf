# 1. setup aws terraform provider
terraform {
  required_providers {
    aws = {
...
# 9. Create a network interface with an ip in the subnet that was created in step 6
...
# 10. Assign an elastic ip to the network interface created in step 9
...
# 11. Create ubuntu server and install, enable apache 2
